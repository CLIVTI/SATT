...
public class runTestScenario_doubleSingleTrack_DoubleToClose {
	...
	public static void main(String[] args) {
		...
		String networkFile = inputDataPath+"testNetwork_singleTrack_DoubleToClose.xml";
		String outputDirectory = inputDataPath+"output_doubleSingleTrack_DoubleToClose";
		...
		Id<Link> linkIdOpposite = Id.createLinkId("q_l_3_BA");
		Link linkToCloseOpposite = nt.getLinks().get(linkIdOpposite  ) ;
		...
		networkChangeEvent.addLink(linkToCloseOpposite);
		NetworkUtils.addNetworkChangeEvent(nt,networkChangeEvent);
		

		NetworkChangeEvent networkChangeEvent2 = new NetworkChangeEvent(8*60*60+240) ;
		...
		networkChangeEvent2.addLink(linkToCloseOpposite);
