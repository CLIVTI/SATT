...
import eventsHandling.singleTrackControlerListener;
...
public class runTestScenario2 {
	...
	public static void main(String[] args) {
		...
		Id<Link> linkIDOppositeDirection = Id.createLinkId("l_2_BA");
		Link linkOppositeDirection = nt.getLinks().get(linkIDOppositeDirection  ) ;
		NetworkChangeEvent networkChangeEvent = new NetworkChangeEvent(8*60*60) ;
		...
		NetworkChangeEvent networkChangeEvent2 = new NetworkChangeEvent(8*60*60+30) ;
